...
resource servicesSubnet 'Microsoft.Network/virtualNetworks/subnets@2024-07-01' = {
...
resource privateEndpointSQL 'Microsoft.Network/privateEndpoints@2024-07-01' = {
...
resource pvtEndpointDnsGroupSQL 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-07-01' = {
...
resource privateEndpointSB 'Microsoft.Network/privateEndpoints@2024-07-01' = {
...
resource pvtEndpointDnsGroupSB 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-07-01' = {
...
//Create the private endpoint
resource privateEndpointCosmos 'Microsoft.Network/privateEndpoints@2024-07-01' = {
...
resource pvtEndpointDnsGroupCosmos 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-07-01' = {
...
//Create the private endpoint
resource privateEndpointAKV 'Microsoft.Network/privateEndpoints@2024-07-01' = {
...
resource pvtEndpointDnsGroupAKV 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2024-07-01' = {
